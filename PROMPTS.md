...
> 
> - *Testar conversão e reprojecao de coordenadas (WGS84 ↔ UTM).*
> - *Testar a classificação correta de geometrias ('reta' vs 'curva').*
> - *Verificar se as geometrias geradas não possuem auto-interseções ou cruzamentos.*
> - *Testar a ordenação e reconstrução de linhas mesmo quando os pontos de entrada estão embaralhados.*
> - *Validar a conformidade de estilo e sintaxe utilizando a ferramenta `ruff`."*
